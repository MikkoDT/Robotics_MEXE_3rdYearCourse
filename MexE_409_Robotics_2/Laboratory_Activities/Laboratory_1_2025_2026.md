...
| **ILO2: Analysis (10 pts)** | Flawless Jacobian & singularity analysis for *both* 3-DOF and 6-DOF. | Accurate Jacobian, but misses minor singularities in 6-DOF. | Minor math errors in either the 3-DOF or 6-DOF analysis. | Completes 3-DOF perfectly, struggles heavily with 6-DOF. | Completes analysis for 3-DOF only; missing 6-DOF. | Major conceptual errors in the 3-DOF analysis. | Fails to compute Jacobian or analyze motion. (0 pts) | **10** |
| **ILO3: Simulation (25 pts)** | Flawless Python/MATLAB execution for *both* 3-DOF and 6-DOF. | Codes run flawlessly for both, minor variable naming issues. | Codes run for both but have slight output discrepancies. | Successful 3-DOF simulation, 6-DOF has major logical errors. | Fails to build 6-DOF completely; 3-DOF has minor bugs. | Significant bugs in both languages; fails to execute properly. | Programs fail to run; missing either Python or MATLAB. (0 pts) | **25** |
| **ILO4: Presentation (20 pts)** | Perfect repository. Strict 10-min presentation, strong math verification, flawless Q&A. | Great repository. Presentation is clear but slightly off timing, good Q&A. | Good repo but missing formatting. Weak math verification. | Disorganized repository. Presentation flow is poor, struggles in Q&A. | Unorganized repo. Exceeds time limits significantly. | Very poor presentation and unable to answer Q&A. | Repo not submitted or presentation unprepared. (0 pts) | **20** |
